    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 添加凭证
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div>
                凭证字<el-select v-model="pzz">
                        <el-option label="记" value="0"></el-option>
                        <el-option label="收" value="1"></el-option>
                        <el-option label="付" value="2"></el-option>
                        <el-option label="转" value="3"></el-option>
                    </el-select>
                    <el-input size="mini" v-model="hao"></el-input>号
                    日期
                    <el-date-picker
                    v-model="date"
                    type="date"
